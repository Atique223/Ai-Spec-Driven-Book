...
const config: Config = {
  ...
  url: 'https://website-gkk4z8c5p-atique223s-projects.vercel.app',
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/your-organization/physical-ai-book/edit/main/website/',
        },
        blog: false, // Disable blog as per specification - focus on educational content
        theme: {
